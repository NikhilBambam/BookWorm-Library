      ...
      <div className='p-6'>
        ...
        <form onSubmit={handleRecordBook}>
          <div className='mb-4'>
            ...
            <input type="email" value={email} onChange={(e)=>setEmail(e.target.value)} placeholder='Borrowers Email' className='w-full px-4 py-2 mt-3 border-2 border-black rounded-md' required></input>
          </div>
          <div className='flex justify-end space-x-4'>
            <button className='px-4 py-2 bg-gray-200 rounded-md hover:bg-300' type="button" onClick={()=>{dispatch(toggleRecordBookPopup())}}>Close</button>
