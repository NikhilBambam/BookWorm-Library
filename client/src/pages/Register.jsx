...
<div className="text-center h-[376px]">
  <div className="flex justify-center mb-12">
    <img src={logo_with_title} alt="logo" className="mb-12 h-44 w-auto"></img>
  </div>
  <p className="text-grey-300 mb-12"> Already have Account? Sign in  now.</p>
...
<div className="w-full max-w-sm">
  <div className="flex justify-center mb-12">
    <div className="flex flex-col-reverse sm:flex-row items-center justify-center gap-5">
      ...
      <img src={logo} alt="logo" className="h-auto w-24 object-cover"></img>
    </div>
  </div>
    ...
    <form onSubmit={handleRegister}>
      ...
      <div className="block md:hidden font-semibold mt-5">
        <p >Already have  Account? 
          <Link to="/login" className="text-sm text-gray-600 hover:underline">Sign In</Link>
        </p>
      </div>
